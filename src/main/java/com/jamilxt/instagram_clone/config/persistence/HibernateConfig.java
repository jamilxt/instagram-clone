package com.jamilxt.instagram_clone.config.persistence;
...
@EnableJpaRepositories("com.jamilxt.instagram_clone.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.jamilxt.instagram_clone.model");
                for (Class<?> clazz : (new Reflections("com.jamilxt.instagram_clone.model")).getTypesAnnotatedWith(Entity.class)) {
